 ...
 */
public class stundentHome extends javax.swing.JFrame {

    /**
     * Creates new form stundentHome
     */
    public stundentHome() {
        initComponents();
    }
       public stundentHome(String roll) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel24.setText("Obtaining Marks");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
           ...
           Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/srm" ,"root","Alex@123");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stundentHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new stundentHome().setVisible(true);
            }
        });
    }
